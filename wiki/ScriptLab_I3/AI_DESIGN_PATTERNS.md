...
- **Why it matters:** Already a vault node ([[Postman MCP]]). Likely how ScriptLabs Studios standardizes connector surfaces over time. May become a procurement requirement for enterprise AI.
- **Status:** adopting via ScriptLabs studio stack.
