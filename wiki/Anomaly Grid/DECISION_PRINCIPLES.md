...
5. **Default to leverage.** If a task can be templated, automated through the ScriptLabs workflow stack, or codified into the vault, do that instead of doing it manually twice.
...
- **Wire it** through the ScriptLabs delivery stack if it is connective tissue (messaging, AI providers, hosting, MCP).
