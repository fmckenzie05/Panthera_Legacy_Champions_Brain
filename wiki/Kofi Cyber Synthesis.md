...
Synthesis of cyber/SOC fundamentals contributed by **Kofi** (see vault-root [[Kofi MOC]]). Sources are in `raw/kofi-*.md` — copies of Kofi's `Obsinthe/` notes, prefixed for sortability.
